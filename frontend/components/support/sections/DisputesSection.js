    ...
    <>
          ...
          <table className="w-full min-w-[700px] border-collapse text-center text-sm">
            ...
            <tbody className="divide-y divide-slate-100">
              ...
              {items.map((d) => (
                <tr
                  key={d.id}
                  className="group hover:bg-slate-50/80 hover:shadow-sm transition-all duration-200"
                >
                    ...
                    {d.order ? (
                      <div className="text-[13px] text-gray-500 flex flex-col gap-0.5">
                        <span className="flex items-center group/b">
                          ...
                          <button
                            onClick={() =>
                              navigator.clipboard.writeText(d.order.buyerId)
                            }
                            className="ml-1 opacity-0 group-hover/b:opacity-100 text-slate-300 hover:text-emerald-600 transition-all"
                            title="Copy Full ID"
                          >
                            <span className="material-symbols-outlined text-[13px] align-middle">
                              content_copy
                        ...
                        <span className="flex items-center group/s">
                          ...
                          <button
                            onClick={() =>
                              navigator.clipboard.writeText(d.order.sellerId)
                            }
                            className="ml-1 opacity-0 group-hover/s:opacity-100 text-slate-300 hover:text-emerald-600 transition-all"
                            title="Copy Full ID"
                          >
                            <span className="material-symbols-outlined text-[13px] align-middle">
                              content_copy
      ...
      {selectedDispute && (
        ...
        >
            ...
            >
                ...
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    ...
                    <p className="font-mono text-[10px] text-slate-400">
                      {(selectedDispute.order?.buyerId ?? "").slice(0, 16)}
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="flex-1 overflow-y-auto px-4 py-4 bg-slate-50/40 flex flex-col gap-3">
                <div className="flex justify-center">
                  <span className="rounded-full bg-slate-200/80 px-3 py-1 text-[10px] font-bold uppercase tracking-widest text-slate-500">
                    Today
                  </span>
                </div>
                ...
                <div className="flex items-end gap-2 flex-row-reverse">
                  ...
                  <div className="max-w-[80%]">
                    <p className="text-[10px] text-slate-400 mb-1 mr-1 text-right">
                      เจ้าหน้าที่
                    </p>
              ...
              <div className="border-t border-slate-200 bg-white px-4 py-3">
                <div className="flex items-center gap-2 rounded-xl border border-slate-200 bg-slate-50 px-3 py-2 opacity-50 cursor-not-allowed">
                  ...
                  <input
                    ...
                    className="flex-1 bg-transparent text-xs outline-none placeholder:text-slate-400 cursor-not-allowed"
                  />
                  <button
                    disabled
          ...
          {/* Main Dispute Panel */}
          <div
            className={`flex w-full max-w-2xl flex-col bg-white shadow-2xl h-full border-l border-slate-200 ${
              closingDispute
            ...
            <div className="flex items-start justify-between border-b border-slate-100 bg-white px-7 py-5">
              <div>
                <div className="flex items-center gap-2 mb-1.5">
                  ...
                  <Badge
                    text={
                      DISPUTE_STATUS_LABEL[selectedDispute.status] ||
                      selectedDispute.status
                    }
                    style={
                      DISPUTE_STATUS_STYLE[selectedDispute.status] ||
                      "bg-slate-100 text-slate-600"
                    }
                  />
                </div>
              ...
              <div className="px-6 py-3.5">
                ...
                <div className="flex items-center gap-2">
                  <div className="flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-amber-100 text-amber-700 text-[10px] font-bold">
                    {selectedDispute.order?.sellerId
                      ?.slice(0, 1)
                      ?.toUpperCase() ?? "S"}
                  </div>
                  <span className="font-mono text-xs font-semibold text-slate-700 truncate">
                ...
                <>
                  <div className="rounded-xl border border-slate-200 bg-white p-5 shadow-sm">
                    <h3 className="mb-4 flex items-center gap-1.5 text-xs font-bold uppercase tracking-wider text-slate-400">
                      ...
                      หลักฐานประกอบ ({disputeDetails.evidence?.length || 0}{" "}
                      ไฟล์)
                    </h3>
                      ...
                      <div className="flex flex-col gap-3">
                        ...
                        {userRole !== "ADMIN" && (
                          <p className="text-center text-xs font-medium text-slate-400">
                            หากต้องการให้ Admin ช่วยระงับเงินไว้ก่อนตัดสิน
                            แจ้งทีม Admin โดยตรง
                          </p>
                        )}
                      </div>
                    </div>
