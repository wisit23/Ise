              ...
              <div className="grid grid-cols-3 gap-4">
                ...
                <div className="col-span-1 relative" ref={categoryDropdownRef}>
                  ...
                  {(showCategoryDropdown || closingCategoryDropdown) && (
                    <div
                      className={`absolute top-full left-0 mt-2 w-full rounded-xl border border-slate-200 bg-white p-1.5 shadow-lg z-20 ${closingCategoryDropdown ? "animate-dropdown-out" : "animate-dropdown-in"}`}
                    >
