              ...
              <div>
                <div className="flex items-baseline gap-2.5">
                  ...
                  <span className="text-xs font-bold text-emerald-700 bg-emerald-100 px-2 py-0.5 rounded-full">
                    ลดไป ฿
                    {selectedVoucher.estimatedDiscount.toLocaleString("th-TH")}
                  </span>
                </div>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      ...
                      <p className="text-[11px] text-emerald-700 mt-0.5">
                        ลดทันที ฿
                        {selectedVoucher.estimatedDiscount.toLocaleString(
                          "th-TH",
                        )}{" "}
                        จากราคาปกติ
                      </p>
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <div>
                        <p className="text-xs font-bold text-emerald-900">
                          คุณมีโค้ดส่วนลดที่ใช้ได้กับสินค้านี้ (
                          {applicableVouchers.length} ใบ)
                        </p>
                        <p className="text-[11px] text-emerald-700">
                          กดเลือกโค้ดเพื่อรับส่วนลดสูงสุด ฿
                          {applicableVouchers[0].estimatedDiscount.toLocaleString(
                            "th-TH",
                          )}
                        </p>
                      </div>
