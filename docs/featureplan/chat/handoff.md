...
[Historical record](../../history/pre-2026-09-09/docs/featureplan/chat/handoff.md) retains previous task IDs, decisions and results by their original date.
